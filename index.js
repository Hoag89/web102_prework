...
*/
// function getUnderfundedGames() {
//     return GAMES_JSON.filter(games => games.pledged < games.goal);
// }
...
// const underfundedGames = getUnderfundedGames();
// console.log("Number of underfunded games:", underfundedGames.length);
